...
/****************************************************/
const viewerC16 = document.getElementById("mediaViewerC16");
const prevBtnC16 = document.getElementById("prevBtnC16");
const nextBtnC16 = document.getElementById("nextBtnC16");
const mediaIndexC16 = document.getElementById("mediaIndexC16");
const totalMediaC16 = document.getElementById("totalMediaC16");
const loaderC16 = document.getElementById("loader-c16");
let currentMediaC16 = 0;
let pendingImageC16 = null;

/****************************************************/
/* DATOS DEL VOLUNTARIADO */
/****************************************************/
const certificadoC16 = {
  nombre: "Certificado: A1 de alemán",
  medios: [
    {
      type: "text",
      content:`
    ...
    },
    {
      ...
      content:`
        ...
        <p><img src="giro_izq.png"/> => links - /links/ - a la izquierda</p>
        <p><img src="recto.png"/> => geradeaus - /guegadaus/ - recto</p>
        <p><img src="giro_der.png"/> => rechts - /guets/ - a la derecha</p>
      `
    },
    {
      type: "text",
    ...
    },
    {
      type: "text",
      content:`
        <p><b>35. Ejercicio de ejemplo con artículos posesivos:</b></p>
        <img src="https://i.postimg.cc/hP7SHctZ/posesivos.jpg"/>
      `,
    },
    {
      type: "text",
...
/* RENDER DEL VISOR */
/****************************************************/
function mostrarLoaderC16() {
  loaderC16.style.display = "block";
  viewerC16.style.display = "none";
}

function ocultarLoaderC16() {
  loaderC16.style.display = "none";
}

function cargarImagenC16(url) {
  if (!url) {
    viewerC16.innerHTML = "";
    viewerC16.style.display = "none";
    ocultarLoaderC16();
  ...
  img.onload = () => {
    ...
    if (pendingImageC16 !== img) return;

    viewerC16.innerHTML = "";
    viewerC16.appendChild(img);

    viewerC16.style.display = "block";
    ocultarLoaderC16();

    pendingImageC16 = null;
  };

  img.onerror = () => {
    if (pendingImageC16 !== img) return;

    viewerC16.innerHTML = "<p>Error al cargar la imagen.</p>";
    viewerC16.style.display = "block";
    ocultarLoaderC16();
...
function renderMediaC16() {
  const media = certificadoC16.medios[currentMediaC16];
  viewerC16.innerHTML="";

  /******** IMAGEN ********/
  if(media.type==="image") {
    cargarImagenC16(media.src);
  }
  ...
  /******** TEXTO ********/
    ...
    viewerC16.appendChild(div);
  }
  /******** CONTADOR ********/
  mediaIndexC16.value=currentMediaC16+1;
  totalMediaC16.textContent = certificadoC16.medios.length;
}

/****************************************************/
/* SIGUIENTE */
/****************************************************/
nextBtnC16.addEventListener("click", () => {
  currentMediaC16++;
  if(currentMediaC16 >= certificadoC16.medios.length) {
    currentMediaC16=0;
  }
  renderMediaC16();
});
...
/* ANTERIOR */
/****************************************************/
prevBtnC16.addEventListener("click",()=>{
  currentMediaC16--;
  if(currentMediaC16 < 0) {
    currentMediaC16 = certificadoC16.medios.length-1;
  }
  renderMediaC16();
});
...
/* SALTAR A PÁGINA */
/****************************************************/
mediaIndexC16.addEventListener("change", () => {
  const value=Number(mediaIndexC16.value);
  if(value>=1 && value<=certificadoC16.medios.length) {
    currentMediaC16=value-1;
    renderMediaC16();
  }
});
